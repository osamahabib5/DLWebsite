         ...
         <div className="p-2 bd-highlight"> 
               <CardDeck style = {{width : "100%", margin: "auto"}} >
                    <Card>  
                        ...
                        <Card.Body>
                            <Card.Title><p className = "title">Trained Tutors</p></Card.Title>
                            <Card.Text>
                    ...
                    <Card>
                        ...
                        <Card.Body>
                            ...
                            <Card.Text>
                            <p className = "title-description">World-class English & Math Program</p>
                            <p className = "title-description">Developed by subject experts</p>
